...
- **다음 세션 착수 순서 추천**: ③·④·①·⑤·⑥과 부산 서구 승격까지 전부 끝났고,
  **2026-08-10 오후 사용자 지시로 전국 확장 1차분(광역시)도 완료**됐다 —
  ...
  남은 것:
  7. **도 지역 확장 — 강원은 부분 완료, 7개 지역 잔여**(§⑰ 남은 일 15, 진행
     기록 §⑱ · `2026-08-10_summary.md` 마지막 세션 섹션). **강원 18곳은
     geo(`gangwon.js`)+DNS 18/18+레코드 전수 반영까지 끝났으나 eminwon 조사는
     10/18곳에서 사용자 퇴근으로 중단** — 잔여 8곳(평창·정선·철원·화천·양구·
     인제·고성·양양)은 레코드 sources에 '미조사'로 표시돼 있고, DNS는 확보됨
     (평창 `eminwon.pc.go.kr` · 정선 jeongseon · 철원 cwg · 화천 ihc · 양구
     yanggu · 인제 inje · 고성 gwgs · 양양 yangyang). 재개 = 해당 도메인
     navigate(허용 클릭) → §⑨ fetch → GW_VERIFIED에 추가. 확보: 춘천
     lastBid 2022-09-01+term 4(차기 재공고 2026-08-06 진행 중!) · 속초
     2026-06-25+term 4 · 홍천 term 4. 삼척은 2026-08-10 재공고 진행 중(과거
     회차 없어 비움). 태백·횡성 eminwon 서버 접속 불가(타임아웃 — 재시도 말고
     다른 채널). 이후 충북 11 · 충남 15 · 전북 14 · 전남광주 27(전남 22+광주 5) ·
     경북 22 · 경남 18 · 제주 2. 같은 절차: `build_region_geo.js`(scratchpad —
     없어지면 §⑬에서 재현, 충북 prefix 33 · 충남 34 · 전북 35 · 전남 36 ·
     광주 24 · 경북 37 · 경남 38 · 제주 39) → DNS → eminwon 전수(§⑨) →
     레코드+테스트. 사용자가 있을 때(도메인 허용 클릭) 진행.
  8. **첨부 hwp 승격 후보**(§⑰ 남은 일 16) — 울산 남구·인천 서해·제물포에
     **속초(2026-06-25 지정공고 hwpx)·삼척(2026-08-10 신청안내서 hwpx)** 추가.
     부산 서구 선례(hwp PrvText 추출, 다운로드는 사용자 승인)로 승격 가능.
     삼척은 WAF가 POST 차단 — 상세·다운로드 모두 GET로.
