...
- **다음 세션 착수 순서 추천**: ③·④·①·⑤·⑥과 부산 서구 승격까지 전부 끝났고,
  **2026-08-10 오후 사용자 지시로 전국 확장 1차분(광역시)도 완료**됐다 —
  ...
  남은 것:
  7. **도 지역 확장 — 강원·충북·충남·전북·전남광주 완료, 3개 지역 잔여**
     (§⑰ 남은 일 15, 강원 §⑱·§⑲ · 충북 §⑳ · 충남 §㉑ · 전북 §㉒ ·
     전남광주 §㉓ · `2026-08-11_summary.md`). 잔여: **경북 22 · 경남 18 ·
     제주 2**(행정시 — 자체 금고 여부 확인 선행). 같은 절차:
     `build_region_geo.js`(scratchpad — 없어지면 §⑬에서 재현, 경북 prefix 37
     (군위 37310은 대구로 이동됨 — 제외 필요) · 경남 38 · 제주 39) →
     DNS(`eminwon.{도메인}.go.kr`) → eminwon 전수(§⑨, 목록 tr 필터는 td
     4~12개 — 평창 유형. 일반구가 있는 시(포항·창원)는 경기 ⓐ안. 약어
     도메인은 게재제호로 소속 확인 — jc=진천·hc=합천) → 레코드+테스트.
     **경남 착수 시 합천은 이미 조사 완료**(지정 2018·2021·2024 3년 간격,
