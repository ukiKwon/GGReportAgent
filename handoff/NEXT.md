...
- **다음 세션 착수 순서 추천**: ③·④·①·⑤·⑥과 부산 서구 승격까지 전부 끝났고,
  **2026-08-10 오후 사용자 지시로 전국 확장 1차분(광역시)도 완료**됐다 —
  ...
  남은 것:
  7. **도 지역 8곳 확장**(§⑰ 남은 일 15) — 강원 18 · 충북 11 · 충남 15 ·
     전북 14 · 전남광주 27(전남 22+광주 5) · 경북 22 · 경남 18 · 제주 2.
     같은 절차: `build_region_geo.js`(scratchpad — 없어지면 §⑬에서 재현) →
     DNS(`eminwon.{도메인}.go.kr`) → eminwon 전수(§⑨) → 레코드+테스트.
     사용자가 있을 때(도메인 허용 클릭) 진행.
  8. **첨부 hwp 승격 후보**(§⑰ 남은 일 16) — 울산 남구·인천 서해·제물포 등.
