...
- **다음 세션 착수 순서 추천**: ③·④·①·⑤·⑥과 부산 서구 승격까지 전부 끝났고,
  **2026-08-10 오후 사용자 지시로 전국 확장 1차분(광역시)도 완료**됐다 —
  ...
  8. **첨부 hwp 승격 — 1차분(고가치 5곳)+양양 배점표 완료(2026-08-13), 잔여는
     ...
     - **잔여(진짜 후순위 — 필드가 안 바뀐다)**: 속초·고성·영동·천안·전주·상주.
       전부 **이미 lastBid+term이 있어** 첨부를 열어도 상세 보강뿐이다.
       진행 시 §㉗·§㉘·§㉙ 요령 재사용.
  단, ②(서울 재조회 잔여 12곳)는 **시점 고정 — 9월 초**(2026-08-19에 9월 중순에서
  앞당겼다. 게재기간 한정 노출 유형을 놓치지 않기 위해서다). 그때 최우선.
  ⚠️ 2026-08-19 기준 이 항목의 열린 것은 **②(9월 초 재조회 12곳)와 ⑧의 상세보강 6곳뿐**이다.
  ②는 §㉕의 curl 경로 + §㉚의 `--http1.1`/UA로 하면 도메인 허용 클릭 없이 진행된다.
