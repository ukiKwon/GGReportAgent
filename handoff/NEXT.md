...
- **다음 세션 착수 순서 추천**: ③·④·①·⑤·⑥과 부산 서구 승격까지 전부 끝났고,
  **2026-08-10 오후 사용자 지시로 전국 확장 1차분(광역시)도 완료**됐다 —
  ...
  남은 것:
  7. **도 지역 확장 — 강원·충북 완료, 6개 지역 잔여**(§⑰ 남은 일 15, 강원
     기록 §⑱·§⑲ · 충북 §⑳ · `2026-08-11_summary.md`). 잔여: 충남 15 · 전북 14 ·
     전남광주 27(전남 22+광주 5) · 경북 22 · 경남 18 · 제주 2(행정시 — 자체 금고
     여부 확인 선행). 같은 절차: `build_region_geo.js`(scratchpad — 없어지면
     §⑬에서 재현, 충남 prefix 34 · 전북 35 · 전남 36 · 광주 24 · 경북 37 ·
     경남 38 · 제주 39) → DNS(`eminwon.{도메인}.go.kr`) → eminwon
     전수(§⑨, 목록 tr 필터는 td 4~12개로 — 평창 유형. 청주처럼 일반구가 있는
     시는 경기 ⓐ안. 약어 도메인은 게재제호로 소속 확인 — jc=진천·hc=합천) →
     레코드+테스트.
