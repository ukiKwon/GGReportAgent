...
def test_same_day_rearchive_removes_old_files(tmp_path):
    ...
    dest1 = archive_institution(db, inst, str(tmp_path / "report_new"), str(tmp_path / "archive"))
    ...
    # 2차 아카이브: 같은 날
    dest2 = archive_institution(db, inst, str(tmp_path / "report_new"), str(tmp_path / "archive"))
