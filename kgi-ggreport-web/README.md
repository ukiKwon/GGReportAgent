...
| **4 · 결재 흐름 + 오케스트레이터** | 🔶 **결재 흐름**(골든 `10`~`30`, §7-5) + **4.1 상태머신** + **4.2 WorkManager**(§7-7). 남은 것: **노드 본문**(4.4 LLM 어댑터 = **문의 1·6 대기**) · SSE(4.3) |
...
그 입력이 `draft`의 산출이라 앞이 막혀 도달하지 못한다. SSE(4.3)도 아직이다.
