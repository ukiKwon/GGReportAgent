...
ROWS = [
    ...
    ("TSKGIAF01", "기관영업분류", "기관영업분류구분코드", 0, "구분코드2", "NULLABLE",
     "기관의 유형 코드. TSKGIAF02.기관영업분류 에서 복사되어 들어온다",
    ...
    ("TSKGIAF01", "저장경로", "저장경로내용", 0, "내용600", "NOT NULL",
     "서버 파일시스템의 저장 경로",
     "분류가 끝나면 값이 바뀐다(미분류 폴더 → classified/{기관영업분류}/{문서년}/{기관명}/). "
    ...
    ("TSKGIAF02", "기관영업분류", "기관영업분류구분코드", 0, "구분코드2", "NOT NULL",
