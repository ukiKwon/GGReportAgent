...
from server.demo_paths import DEMO_ARTIFACTS, DEMO_DB_PATH, DEMO_OUTPUT_ROOT
...
def test_demo_seed_defaults_to_demo_db_not_registry():
    ...
    import server.demo_seed as demo_seed
...
def test_앱이_데모_인덱스를_본다(tmp_path, monkeypatch):
    from server.demo_paths import DEMO_INDEX_DB_PATH
