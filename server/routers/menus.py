...
보안 경계가 아니다(`server/menus.py` 상단 참고) — 프로필이 자기신고라 서버가
...
from server.menu_repository import load_overrides, save_changes
from server.menus import ADMIN_MENU, MENU_KEYS, MENUS, all_roles, menus_for
from server.teams import ROLES
